...
<nav class="navbar navbar-expand-sm navbar-light" id="back-color">
        <div class="container">
            <a class="navbar-brand" href="#"> <img src="logo.png" alt="Avatar Logo" style="width:40px;" class="rounded-pill"> </a>
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavId">
                <ul class="navbar-nav me-auto mt-2 mt-lg-0">
                    ...
                    <!--Add index.html-->
                    <li class="nav-item">
                        <a class="nav-link text-light" href="project.html"><b>PROJECTS</b></a>
                    </li>
                    <!--Add index.html-->
                    <li class="nav-item">
